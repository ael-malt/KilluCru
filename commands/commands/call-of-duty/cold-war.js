...
module.exports = {
    ...
    callback: async(message, arguments, text, client) => {
        ...
        if(!arguments[1]) return message.channel.send('PVeuillez entrer une plateforme valide \npsn \nsteam\nxbl\nbattle\nacti\nuno ( numerical identifier )')
        ...
        try {
            ...
            let data = await cod_api.CWmp(arguments[0], arguments[1])
            const embed = new Discord.MessageEmbed()
            .setColor('#CC3033k')
            .setTitle('Stats multijoueurs Call of Duty Cold War')
            ...
            .setFooter('Call of Duty Cold War stats by thenono1')
