...
module.exports = {
    ...
    callback: async (message, arguments, text, client) => {
        ...
        try {
            ...
            let data = await cod_api.BO4mp(arguments[0], arguments[1])
            const embed = new Discord.MessageEmbed()
                .setColor('#CC3033k')
                .setTitle('Stats multijoueurs Call of Duty Black Ops 4')
                ...
                .setFooter('Call of Duty Black Ops 4 stats by thenono1')
